...
async function main() {
      ...
      data: [
        {
          ...
          description:
            "Der legendäre Birkin von Hermès in exzellentem Zustand. Dieses exklusive Taschenstück aus Leder ist ein Investment in die Luxuswelt. Die goldene Hardware und das charakteristische H-Brand-Logo machen diese Tasche zu einem Meisterwerk der Französisch-italienischen Luxusmarke.",
          status: "PUBLISHED",
          brandId: "hermes",
        ...
        },
        {
          ...
          description:
            "Die ikonische Chanel Classic Flap in schwarz. Diese Tasche ist ein Kultstück der Modegeschichte. Das Leder ist vollständig glatt, die Hardware in Gold ist perfekt.",
          status: "PUBLISHED",
          brandId: "chanel",
        ...
        },
        {
          ...
          description:
            "Die Klassische Speedy 25 von Louis Vuitton in Monogramm-Stoff. Eine der ikonischsten Taschen der Welt. Das Taschenmaterial ist in perfektem Zustand.",
          status: "PUBLISHED",
        ...
        },
        {
          ...
          description:
            "Die Mini Jodhpur von Bottega Veneta in reizvollem Brauntone. Das Iconic Intrecci-Weave ist ein Meisterstück der Marke. Die Tasche ist mit originalem Dust-Bag erhältlich.",
          status: "PUBLISHED",
        ...
        },
        {
          ...
          description:
            "Die Sylvie Small von Saint Laurent ist eine elegante, minimalistische Tasche. Das charakteristische Red-Sole Design ist das Markenzeichen.",
          status: "PUBLISHED",
        ...
        },
        {
          ...
          description:
            "Die Re-Edition 2005 von Prada ist ein ikonisches Stück. Das schwarze Nappa-Leder mit dem charakteristischen Triangle-Logo.",
          status: "PUBLISHED",
          brandId: "prada",
          categoryId: "shoulder-bags",
        ...
        },
        {
          ...
          description:
            "Die Saddle Tasche von Dior in einem der ikonischsten Farben der Marke. Das Oblique-Logo ist präsent und die Tasche ist in perfektem Zustand.",
          status: "PUBLISHED",
          brandId: "dior",
          categoryId: "shoulder-bags",
        ...
        },
        {
          ...
          description:
            "Die Saint Louis PM von Goyard in schwarz. Das charakteristische Straw-Design und das Goyard-Logo machen diese Tasche zu einem Klassiker.",
          status: "PUBLISHED",
          brandId: "goyard",
          categoryId: "tote-bags",
        ...
        },
        {
          ...
          description:
            "Die Marmont Small von Gucci in schwarzem Leder. Das charakteristische Snake-Logo ist auf der Tasche präsent.",
          status: "PUBLISHED",
          brandId: "gucci",
          categoryId: "shoulder-bags",
        ...
        },
        {
          ...
          description:
            "Die Stark Backpack von MCM in Visetos-Nummerierung. Ein moderner Twist auf eine Kultklasse.",
          status: "PUBLISHED",
          brandId: "mcm",
          categoryId: "tote-bags",
  ...
  if (imageCount === 0) {
    await db.productImage.createMany({
      data: [
        {
          productId: "hermes-birkin-30-gold",
          url: "https://images.unsplash.com/photo/158443307777-6e3a6a4f5d0d?w=1200",
          altText: "Hermès Birkin 30 Gold",
          position: 0,
          isPrimary: true,
        },
        {
          productId: "chanel-flap-medium-black",
          url: "https://images.unsplash.com/photo/1566647952449-5d094d3c4e0d?w=1200",
          altText: "Chanel Classic Flap",
          position: 0,
          isPrimary: true,
        },
        {
          productId: "lv-speedy-25-monogram",
          url: "https://images.unsplash.com/photo/1554520681-7ac65d85c58f?w=1200",
          altText: "LV Speedy 25 Monogram",
          position: 0,
          isPrimary: true,
        },
        {
          productId: "bv-mini-jodhpur-brown",
          url: "https://images.unsplash.com/photo/158443307777-6e3a6a4f5d0d?w=1200",
          altText: "Bottega Veneta Jodhpur",
          position: 0,
          isPrimary: true,
        },
        {
          productId: "sylvie-small-black",
          url: "https://images.unsplash.com/photo/1566647952449-5d094d3c4e0d?w=1200",
          altText: "YSL Sylvie Small",
          position: 0,
          isPrimary: true,
        },
        {
          productId: "prada-re-edition-2005-black",
          url: "https://images.unsplash.com/photo/1554520681-7ac65d85c58f?w=1200",
          altText: "Prada Re-Edition",
          position: 0,
          isPrimary: true,
        },
        {
          productId: "dior-saddle-blue",
          url: "https://images.unsplash.com/photo/158443307777-6e3a6a4f5d0d?w=1200",
          altText: "Dior Saddle Blue",
          position: 0,
          isPrimary: true,
        },
        {
          productId: "goyard-saint-louis-pm-black",
          url: "https://images.unsplash.com/photo/1566647952449-5d094d3c4e0d?w=1200",
          altText: "Goyard Saint Louis",
          position: 0,
          isPrimary: true,
        },
        {
          productId: "gucci-marmont-small-black",
          url: "https://images.unsplash.com/photo/1554520681-7ac65d85c58f?w=1200",
          altText: "Gucci Marmont",
          position: 0,
          isPrimary: true,
        },
        {
          productId: "mcm-stark-backpack-visetos",
          url: "https://images.unsplash.com/photo/158443307777-6e3a6a4f5d0d?w=1200",
          altText: "MCM Stark Backpack",
          position: 0,
          isPrimary: true,
        },
      ],
